...
public class TransactionCreateKafkaProducer {
    private static final Logger logger = LoggerFactory.getLogger(TransactionCreateKafkaProducer.class);
    ...
    public void writeToKafka(Transaction transaction) {
        logger.info("TransactionCreateKafkaProducer: {}", transaction);
        TransactionEvent transactionEvent = new TransactionEvent(transaction, TransactionAction.CREATE);
